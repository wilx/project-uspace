...
\item[\linesep{} (\texttt{U+2028})] \lstinline|\ifvmode\else\newline\fi|
\item[\nel{} (\texttt{U+0085})] \lstinline|\ifvmode\else\newline\fi|
...
The \linesep{} and \nel{} characters insert a line break within a paragraph.
They are ignored in vertical mode, including before the first paragraph
and immediately after a \parasep{} character.
...
\begin{description}[style=nextline, labelwidth=4.5em, leftmargin=!,
  labelindent=0em]
  \item[\texttt{v0.06}] Ignore \linesep{} and \nel{} in vertical mode,
    including before the first paragraph and immediately after a
    \parasep{}, instead of raising an error. Their line-breaking behaviour
    within paragraphs is unchanged.
